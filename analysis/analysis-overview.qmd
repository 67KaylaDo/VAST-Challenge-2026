...
The investigation draws on the full 185,147-event MC2 log. Four figures frame the scale of what follows:

| Metric | Value |
| --- | --- |
| Events in log | 185,147 |
| Malicious relay events | 235 |
| Departments touched | 6 / 6 |
| False positives from the proposed fix | 0 |
